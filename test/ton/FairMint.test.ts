...
describe('FairMint.sol', () => {
  test('fairMintTest', async () => {
    ...
    const CONFIRM_GAS = await f4.CONFIRM_GAS()
    ...
    await msa.addCallers([referralAddr, fAddr, marsTokenAddr, priceFeederAddr, receiverAdminAddr])
    //MsgSenderNotSigner
    {
